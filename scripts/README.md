...
The script is deliberately synthesis-only and cannot create or destroy AWS resources. Use the approval-gated [live E2E runner](../LIVE-E2E.md) for a real deployment test.
