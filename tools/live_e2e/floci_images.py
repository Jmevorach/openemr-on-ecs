...
DEFAULT_MYSQL_SOURCE_IMAGE = os.environ.get(
    "OPENEMR_FLOCI_MYSQL_SOURCE_IMAGE",
    "mysql:8.0@sha256:7dcddc01f13bab2f15cde676d44d01f61fc9f99fe7785e86196dfc07d358ae2b",
)
DEFAULT_VALKEY_IMAGE = os.environ.get(
    "OPENEMR_FLOCI_VALKEY_IMAGE",
    "valkey/valkey:8@sha256:495e4fecdc98ee48a20b207726caa5ab6451e0fac3642a9be10d9e70b3068df6",
)
